    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubSports", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipments_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScoreConfirmations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Sports",
                columns: new[] { "Id", "Name", "NumberTimes" },
                values: new object[,]
                {
                    { 1, "Padel", 3 },
                    { 2, "Futbol", 2 }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Moreno", "test", "Sergio", "098f6bcd4621d373cade4e832627b4f6", "Admin", true },
                    { 2, "Lerepe", "user", "Pepe", "098f6bcd4621d373cade4e832627b4f6", "User", false }
                });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "CountryId", "Name" },
                values: new object[] { 1, 1, "Málaga" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScoreConfirmations_PlayerId",
                table: "ScoreConfirmations",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_ScoreConfirmations_ScoreId",
                table: "ScoreConfirmations",
                column: "ScoreId");

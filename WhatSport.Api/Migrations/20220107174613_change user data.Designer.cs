...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhatSport.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "admin@uoc.edu",
                            Name = "Sergio",
                            Password = "08458ec8927fa3f9c176bcf1fffc671c",
                            Role = "Admin",
                            Status = true
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Login = "user4",
                            Name = "Florencio",
                            Password = "c4882f5eefc3c13ecc6b7e1954e9ea85",
                            Role = "User",
                            Status = true
                        },
                        new
            ...
            modelBuilder.Entity("WhatSport.Domain.Models.ScoreConfirmation", b =>
                {
                    b.HasOne("WhatSport.Domain.Models.Player", null)
                        .WithMany("ScoreConfirmations")
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhatSport.Domain.Models.Score", null)
                        .WithMany("ScoreConfirmations")
